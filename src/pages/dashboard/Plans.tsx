...
const PLANS = [
  {
    ...
    name: 'Basic',
    price: 10,
    description: 'For founders kicking the tires.',
    features: ['7-day free trial', '1 brand kit', 'AI strategist · 3 plans/mo', '200 outreach sends/mo', '60 voice minutes', 'Email support'],
  ...
  },
  {
    ...
    price: 89,
    popular: true,
    description: 'When growth becomes a real job.',
    features: ['Unlimited brand kits', 'AI strategist · unlimited', 'Outreach · 5,000 sends/mo', 'Voice agent · 1,500 minutes', 'Lead finder · 10 zips / 5K leads', 'Scheduling + invoicing + site builder', 'Live chat support'],
  ...
  },
  {
    ...
    name: 'Scale',
    price: 249,
    description: 'Multi-brand teams and small agencies.',
    features: ['10 workspaces', 'Custom AI training', 'Outreach · 25,000 sends/mo', 'Voice agent · 6,000 minutes', 'Lead finder · unlimited', 'Payroll + integrations API', 'Dedicated CSM'],
